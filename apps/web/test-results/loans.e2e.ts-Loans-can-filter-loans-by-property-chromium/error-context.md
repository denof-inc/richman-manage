...
- Name: Loans >> can filter loans by property
- Location: /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/loans.e2e.ts:31:7
...
Call log:
  - waiting for locator('select').first()
    - locator resolved to <select class="rounded border px-2 py-1 text-sm">…</select>
  - attempting select option action
    ...
    at /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/loans.e2e.ts:36:26
```
