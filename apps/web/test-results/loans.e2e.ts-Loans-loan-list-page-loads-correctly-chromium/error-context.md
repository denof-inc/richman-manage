...
- Name: Loans >> loan list page loads correctly
- Location: /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/loans.e2e.ts:4:7
...
Locator: getByRole('columnheader', { name: 'ローン名' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('columnheader', { name: 'ローン名' })

    at /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/loans.e2e.ts:23:68
```
