...
- Name: Loans >> can navigate to loan detail
- Location: /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/loans.e2e.ts:57:7
...
Expected pattern: /\/loans\/loan-001$/
Received string:  "http://localhost:3000/loans"
Call log:
  - expect.toHaveURL with timeout 5000ms
  - waiting for locator(':root')
    9 × locator resolved to <html lang="en">…</html>
      - unexpected value "http://localhost:3000/loans"

    at /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/loans.e2e.ts:64:24
```
