...
- Name: Rent Roll >> rent roll list page loads correctly
- Location: /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/rent-roll.e2e.ts:4:7

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('text=入居中') resolved to 18 elements:
    1) <p class="text-sm font-medium text-text-muted">入居中</p> aka getByRole('paragraph').filter({ hasText: '入居中' })
    2) <option value="occupied">入居中</option> aka locator('div').filter({ hasText: /^入居状況すべて入居中空室$/ }).getByRole('combobox')
    3) <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold bg-accent text-white">入居中</span> aka locator('div').filter({ hasText: /^101住居入居中$/ }).locator('span').nth(1)
    4) <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold bg-accent text-white">入居中</span> aka locator('div').filter({ hasText: /^201住居入居中$/ }).locator('span').nth(1)
    5) <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold bg-accent text-white">入居中</span> aka locator('div').filter({ hasText: /^202住居入居中$/ }).locator('span').nth(1)
    6) <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold bg-accent text-white">入居中</span> aka locator('div').filter({ hasText: /^P1駐車場入居中$/ }).locator('span').nth(1)
    7) <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold bg-accent text-white">入居中</span> aka getByRole('row', { name: '101 住居 入居中 45.5㎡ 1LDK ￥180,' }).locator('span').nth(1)
    8) <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold bg-accent text-white">入居中</span> aka getByRole('row', { name: '201 住居 入居中 45.5㎡ 1LDK ￥185,' }).locator('span').nth(1)
    9) <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold bg-accent text-white">入居中</span> aka getByRole('row', { name: '202 住居 入居中 50㎡ 1LDK ￥195,000' }).locator('span').nth(1)
    10) <span class="inline-flex rounded-full px-2 py-1 text-xs font-semibold bg-accent text-white">入居中</span> aka getByRole('row', { name: 'P1 駐車場 入居中 - ￥25,000 田中 太郎' }).locator('span').nth(1)
    ...

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=入居中')

    at /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/rent-roll.e2e.ts:12:44
```
