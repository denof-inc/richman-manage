...
- Name: Room Detail >> displays contract information for occupied rooms
- Location: /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/room-detail.e2e.ts:36:7
...
Locator: locator('text=現在の契約情報')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=現在の契約情報')

    at /Users/tttela/Documents/Work/denof/works/250428richman-manage/dev/richman-manage/apps/web/e2e/room-detail.e2e.ts:40:48
```
