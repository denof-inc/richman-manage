          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleUpdateNotifications('securityAlerts', checked)}
              />
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleUpdateNotifications('propertyUpdates', checked)}
              />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleUpdateNotifications('marketingEmails', checked)}
              />
            </div>
          </CardContent>
        </Card>
